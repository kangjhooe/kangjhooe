...
export const metadata: Metadata = {
  title: "Tentang",
  description:
    "Profil lengkap Kang Jhooe sebagai Fullstack Developer madrasah yang menekankan inovasi, manfaat, dan keberlanjutan.",
};

const timelines = [
  {
    title: "Digital Strategist - MA Al-Falah Krui",
    period: "2022 - Sekarang",
    detail:
      "Mendesain roadmap digitalisasi madrasah, mengawal implementasi LMS XClass dan workshop literasi teknologi untuk guru.",
  },
  {
...
const valuePillars = [
  {
    title: "Inovasi",
    detail: "Meracik solusi yang sesuai dengan budaya madrasah tanpa kehilangan esensi tradisi.",
  },
  {
    title: "Manfaat",
    detail: "Teknologi harus membantu guru mengajar dan memudahkan santri belajar kapan saja.",
  },
  {
    title: "Keberlanjutan",
      ...
      <section className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="space-y-4">
          ...
          <p className="text-base leading-relaxed text-foreground/80">
            ...
            belajar digital untuk madrasah di Indonesia. Menggabungkan keahlian teknis
            Next.js, NestJS, dan manajemen server Linux untuk memastikan sistem stabil dan aman.
          </p>
          <p className="text-base leading-relaxed text-foreground/80">
            Berawal dari kebutuhan internal MA Al-Falah Krui, ia membangun XClass agar guru
            dapat mengelola kelas virtual, menjaga interaksi dengan orang tua, serta
            memonitor perkembangan santri secara komprehensif.
          </p>
          <p className="text-base leading-relaxed text-foreground/80">
            Selain mengembangkan produk, Kang Jhooe rutin memfasilitasi sesi mentoring
            digitalisasi untuk pimpinan dan tim madrasah. Misinya sederhana: memastikan
